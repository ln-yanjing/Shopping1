...
action="${pageContext.request.contextPath}/ProductsServlet?action=add" method="post">
  &nbsp;
         ...
         <td class="ta_01" bgcolor="#ffffff" colspan="3"> <input type="text" name="imgurl" size="30" value="" />
          ...
          <tr>
              <td align="center" bgcolor="#f5fafe" class="ta_01">商品描述</td>
               <td class="ta_01" bgcolor="#ffffff" colspan="3" height="10"> <input type="text" name="desciption" size="100" value="" />
               </td>
               </tr>
         <tr>
